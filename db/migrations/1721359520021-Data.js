module.exports = class Data1721359520021 {
  ...
  async up(db) {
    await db.query(`CREATE TABLE "objekt" ("id" character varying NOT NULL, "owner" text NOT NULL, "minted_at" TIMESTAMP WITH TIME ZONE NOT NULL, "received_at" TIMESTAMP WITH TIME ZONE NOT NULL, "serial" integer NOT NULL, "transferable" boolean NOT NULL, "collection_id" uuid, CONSTRAINT "PK_a50fda223abd7f6ae55f2cf629f" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_d2ddf18405b46538e169ab03e8" ON "objekt" ("owner") `)
    await db.query(`CREATE INDEX "IDX_3d4c25bad83bb3fdae75fc0692" ON "objekt" ("received_at") `)
    await db.query(`CREATE INDEX "IDX_19209bac5cab521e9327f74013" ON "objekt" ("serial") `)
    await db.query(`CREATE INDEX "IDX_f47af96878c586b3fbb6d9439c" ON "objekt" ("transferable") `)
    await db.query(`CREATE INDEX "IDX_cc0196669f13f5958a307824a2" ON "objekt" ("collection_id") `)
    await db.query(`CREATE TABLE "transfer" ("id" uuid NOT NULL DEFAULT uuidv7(), "from" text NOT NULL, "to" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "token_id" text NOT NULL, "hash" text NOT NULL, "objekt_id" character varying, "collection_id" uuid, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_15a8d2966ae7e5e9b2ff47104f" ON "transfer" ("collection_id") `)
    await db.query(`CREATE TABLE "collection" ("id" uuid NOT NULL DEFAULT uuidv7(), "contract" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "slug" text NOT NULL, "collection_id" text NOT NULL, "season" text NOT NULL, "member" text NOT NULL, "artist" text NOT NULL, "collection_no" text NOT NULL, "class" text NOT NULL, "thumbnail_image" text NOT NULL, "front_image" text NOT NULL, "back_image" text NOT NULL, "background_color" text NOT NULL, "text_color" text NOT NULL, "accent_color" text NOT NULL, "como_amount" integer NOT NULL, "on_offline" text NOT NULL, "band_image_url" character varying(255), CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_e814aff6539600dfcc88af41fc" ON "collection" ("contract") `)
    await db.query(`CREATE INDEX "IDX_f2c977a66579d262693a8cdbcd" ON "collection" ("created_at") `)
    await db.query(`CREATE UNIQUE INDEX "IDX_75a6fd6eedd7fa7378de400b0a" ON "collection" ("slug") `)
    ...
    await db.query(`CREATE INDEX "IDX_6f89ec57ebbfd978e196751051" ON "collection" ("artist") `)
    await db.query(`CREATE INDEX "IDX_a8dbe2a49e54f73e2e7063dbb0" ON "collection" ("collection_no") `)
    await db.query(`CREATE INDEX "IDX_d01899107849250643b52f2324" ON "collection" ("class") `)
    await db.query(`CREATE INDEX "IDX_429351eac26f87942861266e48" ON "collection" ("on_offline") `)
    await db.query(`CREATE TABLE "como_balance" ("id" uuid NOT NULL DEFAULT uuidv7(), "token_id" numeric NOT NULL, "owner" text NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_965a782766b42e9c0cf627e9295" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_084bf8fee4d9152f4e0a3c5c36" ON "como_balance" ("token_id") `)
    await db.query(`CREATE INDEX "IDX_625af50d78a8e51e688e96a331" ON "como_balance" ("owner") `)
    await db.query(`CREATE INDEX "IDX_d840d7bff36ad3e0d91ea8b680" ON "como_balance" ("amount") `)
    await db.query(`CREATE TABLE "vote" ("id" uuid NOT NULL DEFAULT uuidv7(), "from" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "contract" text NOT NULL, "poll_id" integer NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_0d7459852150cf964af26adcf6" ON "vote" ("poll_id") `)
    ...
    await db.query(`ALTER TABLE "transfer" ADD CONSTRAINT "FK_15a8d2966ae7e5e9b2ff47104f0" FOREIGN KEY ("collection_id") REFERENCES "collection"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_084bf8fee4d9152f4e0a3c5c36"`)
    ...
    await db.query(`ALTER TABLE "transfer" DROP CONSTRAINT "FK_15a8d2966ae7e5e9b2ff47104f0"`)
  }
};
